  ...
  return (
    <Container>
      <Stack spacing={4} mx={10}>
        ...
        <Heading fontSize="lg">Information we collect</Heading>
        ...
        <Text>When you register for an Account, we may ask for your email address.</Text>

        <Heading fontSize="lg">How we use your information</Heading>
        ...
        <Heading fontSize="lg">CCPA Privacy Rights (Do Not Sell My Personal Information)</Heading>
        ...
        <Heading fontSize="lg">GDPR Data Protection Rights</Heading>
        ...
        <Heading fontSize="lg">Children&#39;s Information</Heading>
